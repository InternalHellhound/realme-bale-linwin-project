...
> [!CAUTION]
> Текущая версия модифицированного рекавери находится в разработки, а функционал, который данное рекавери предоставляет, в данный момент не полный. В будущем все утилиты будут добавлены, а ошибки - исправленны.
...
#### Режим LKM (Доступен только для KernelSU, так как в его Next форке поддержку данного режима прекратили с версии 1.0.7)
...
### Magisk
Инструкция похожа с патчем [режима LKM для KernelSU](https://github.com/InternalHellhound/realme-bale-linwin-project/main/Guides/English/Miscellaneous/Rooting.md#lkm-mode).
